...
var Message = function () {
    var _classDecorators = [Table({ tableName: 'messages' })];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = Model;
    ...
    var Message = _classThis = /** @class */ (function (_super) {
        ...
        function Message_1() {
            ...
            __runInitializers(_this, _text_extraInitializers);
            return _this;
        }
        return Message_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _text_decorators = [Column({ type: DataType.STRING, allowNull: false })];
